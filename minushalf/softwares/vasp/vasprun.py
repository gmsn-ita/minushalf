...
class Vasprun():
    ...
    def __init__(self, filename: str):
        ...
        def _get_atoms(self) -> dict:
            ...
            try:
                ...
                for value in atoms_tree.find("set").findall("rc"):
                    ...
                    atoms[atom_index[1].text.strip(
                    )] = atom_index[0].text.strip()
            except:
                raise Exception(
                    "Vasprun parser do not found atoms informations")
            finally:
                atoms_tree.clear()
            return atoms
		...
		"""
            ...
            xml_text = []
            with open(self.vasprun_path, "r") as vasprun:
                for line in vasprun:
                    ...
                    elif not start_tag_identified and start_tag_regex.match(
                            line):
