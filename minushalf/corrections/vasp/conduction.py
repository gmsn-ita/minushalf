...
simple conduction correction and optimizes the necessary parameters.
"""
import itertools
import os
import shutil
...
class VaspConductionCorrection(Correction):
    """
    An algorithm that correct the potential in the most
    influent orbital in cbm character
    """
    def __init__(
        self,
        root_folder: str,
        ...
        self.conduction_potfiles_folder = "conduct_potfiles"
    ...
    def _get_corrections_indexes(self) -> dict:
        ...
        for row, column in itertools.product(rows_name, columns_name):
            projection = self.cbm_projection[column][row]
    ...
    def _find_cut(self, symbol: str, base_path: str) -> tuple:
        ...
        cut, eigenvalue = ternary_search(
            0,
            15,
            VaspConductionCorrection.find_band_gap,
            **function_args,
        )
    ...
    def find_band_gap(
        ...
        VaspConductionCorrection._write_potfile(
            cut,
            symbol,
        ...
        VaspConductionCorrection._join_potfiles(
            base_path,
            default_potential_filename,
            atoms,
            potfiles_folder,
