...
def test_potcar_ag(file_path):
    ...
    assert np.isclose(potcar.potential[0], 0.77325279e2)
    assert np.isclose(potcar.potential[-1], 0.34828552e0)
...
def test_potcar_c(file_path):
    ...
    assert np.isclose(potcar.potential[0], 0.20536679e2)
    assert np.isclose(potcar.potential[-1], 0.46962343e-1)
    assert potcar.last_lines[0].strip() == "gradient corrections used for XC"
    assert potcar.last_lines[-1].strip() == "End of Dataset"
...
def test_potcar_er(file_path):
    ...
    assert np.isclose(potcar.potential[0], 0.33161532e3)
    assert np.isclose(potcar.potential[-1], 0.77488015e0)
    assert potcar.last_lines[0].strip() == "gradient corrections used for XC"
    assert potcar.last_lines[-1].strip() == "End of Dataset"
...
def test_potcar_f(file_path):
    ...
    assert np.isclose(potcar.potential[0], 0.25090202e2)
    assert np.isclose(potcar.potential[-1], 0.84227234e-1)
    assert potcar.last_lines[0].strip() == "gradient corrections used for XC"
    assert potcar.last_lines[-1].strip() == "End of Dataset"
...
def test_potcar_fe(file_path):
    ...
    assert np.isclose(potcar.potential[0], 0.86392220e2)
    assert np.isclose(potcar.potential[-1], 0.21998356e0)
    assert potcar.last_lines[0].strip() == "gradient corrections used for XC"
    assert potcar.last_lines[-1].strip() == "End of Dataset"
...
def test_potcar_ga(file_path):
    ...
    assert np.isclose(potcar.k_max, 71.8095875659991)
    assert np.isclose(potcar.potential[0], 0.59460173e2)
    assert np.isclose(potcar.potential[-1], 0.10631365e0)
    assert potcar.last_lines[0].strip() == "gradient corrections used for XC"
    assert potcar.last_lines[-1].strip() == "End of Dataset"
...
def test_potcar_h(file_path):
    ...
    assert np.isclose(potcar.potential[0], 0.24361675E1)
    assert np.isclose(potcar.potential[-1], 0.62759860e-2)
    assert potcar.last_lines[0].strip() == "gradient corrections used for XC"
    assert potcar.last_lines[-1].strip() == "End of Dataset"
...
def test_potcar_he(file_path):
    ...
    assert np.isclose(potcar.k_max, 170.075338972103)
    assert np.isclose(potcar.potential[0], 0.48278121e1)
    assert np.isclose(potcar.potential[-1], 0.12539022e-1)
    assert potcar.last_lines[0].strip() == "gradient corrections used for XC"
    assert potcar.last_lines[-1].strip() == "End of Dataset"
...
def test_potcar_mg(file_path):
    ...
    assert np.isclose(potcar.potential[0], 0.22502855e2)
    assert np.isclose(potcar.potential[-1], 0.40609408e-1)
    assert potcar.last_lines[0].strip() == "gradient corrections used for XC"
    assert potcar.last_lines[-1].strip() == "End of Dataset"
...
def test_potcar_ir(file_path):
    ...
    assert np.isclose(potcar.k_max, 71.8095875659991)
    assert np.isclose(potcar.potential[0], 0.12669216e3)
    assert np.isclose(potcar.potential[-1], 0.31623286e0)
    assert potcar.last_lines[0].strip() == "gradient corrections used for XC"
    assert potcar.last_lines[-1].strip() == "End of Dataset"
...
def test_potcar_mo(file_path):
    ...
    assert np.isclose(potcar.potential[0], 0.11440305e3)
    assert np.isclose(potcar.potential[-1], 0.23531220e0)
    assert potcar.last_lines[0].strip() == "gradient corrections used for XC"
    assert potcar.last_lines[-1].strip() == "End of Dataset"
...
def test_potcar_n(file_path):
    ...
    assert np.isclose(potcar.k_max, 124.721915246209)
    assert np.isclose(potcar.potential[0], 0.21549196e2)
    assert np.isclose(potcar.potential[-1], 0.58613255e-1)
    assert potcar.last_lines[0].strip() == "gradient corrections used for XC"
    assert potcar.last_lines[-1].strip() == "End of Dataset"
...
def test_potcar_ne(file_path):
    ...
    assert np.isclose(potcar.potential[0], 0.19440536e2)
    assert np.isclose(potcar.potential[-1], 0.12060531e0)
    assert potcar.last_lines[0].strip() == "gradient corrections used for XC"
    assert potcar.last_lines[-1].strip() == "End of Dataset"
...
def test_potcar_ru(file_path):
    ...
    assert np.isclose(potcar.potential[0], 0.57352320e2)
    assert np.isclose(potcar.potential[-1], 0.29557935e0)
    assert potcar.last_lines[0].strip() == "gradient corrections used for XC"
    assert potcar.last_lines[-1].strip() == "End of Dataset"
...
def test_potcar_s(file_path):
    ...
    assert np.isclose(potcar.potential[0], 0.25157640e2)
    assert np.isclose(potcar.potential[-1], 0.11327915e0)
    assert potcar.last_lines[0].strip() == "gradient corrections used for XC"
    assert potcar.last_lines[-1].strip() == "End of Dataset"
...
def test_potcar_sn(file_path):
    ...
    assert np.isclose(potcar.potential[0], 0.31273018e2)
    assert np.isclose(potcar.potential[-1], 0.18728585e0)
    assert potcar.last_lines[0].strip() == "gradient corrections used for XC"
    assert potcar.last_lines[-1].strip() == "End of Dataset"
...
def test_potcar_tc(file_path):
    ...
    assert np.isclose(potcar.potential[0], 0.31304226e2)
    assert np.isclose(potcar.potential[-1], 0.29089674e0)
    assert potcar.last_lines[0].strip() == "gradient corrections used for XC"
    assert potcar.last_lines[-1].strip() == "End of Dataset"
...
def test_potcar_v(file_path):
    ...
    assert np.isclose(potcar.k_max, 69.9198615774202)
    assert np.isclose(potcar.potential[0], 0.61993946e2)
    assert np.isclose(potcar.potential[-1], 0.18556083e0)
    assert potcar.last_lines[0].strip() == "gradient corrections used for XC"
    assert potcar.last_lines[-1].strip() == "End of Dataset"
...
def test_potcar_w(file_path):
    ...
    assert np.isclose(potcar.k_max, 68.0301355888413)
    assert np.isclose(potcar.potential[0], 0.12147212e3)
    assert np.isclose(potcar.potential[-1], 0.23490619e0)
    assert potcar.last_lines[0].strip() == "gradient corrections used for XC"
    assert potcar.last_lines[-1].strip() == "End of Dataset"
...
def test_potcar_xe(file_path):
    ...
    assert np.isclose(potcar.k_max, 75.5890395431569)
    assert np.isclose(potcar.potential[0], 0.29945148e3)
    assert np.isclose(potcar.potential[-1], 0.25592291e0)
    assert potcar.last_lines[0].strip() == "gradient corrections used for XC"
    assert potcar.last_lines[-1].strip() == "End of Dataset"
